            ...
            <div className=" flex items-center gap-3 mt-[45px]">
                <div className="item-1">
                    <div className="card w-80 h-90 bg-base-100 shadow-xl">
                        <figure><img src="public/img/activity/sport.jpg" alt="Shoes" /></figure>
                ...
                <div className="item-2">
                    <div className="card w-96  bg-base-100 shadow-xl">
                        <figure><img src="public/img/activity/graduation.jpg" alt="Shoes" /></figure>
                        <div className="card-body">
                ...
                <div className="item-3">
                    <div className="card w-80 h-90 bg-base-100 shadow-xl">
                        <figure><img src="public/img/activity/teamwork.jpg" alt="Shoes" /></figure>
                        <div className="card-body">
